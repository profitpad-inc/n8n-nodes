...
export class HubspotApi implements INodeType {
  description: INodeTypeDescription = {
    displayName: 'Hubspot',
    name: 'hubspotApi',
    icon: 'file:hubspot-icon.svg',
    group: ['transform'],
    version: 1,
    subtitle: '={{$parameter["operation"] + ": " + $parameter["resource"]}}',
    description: 'Interact with the Hubspot API.',
    usableAsTool: true,
    defaults: {
      name: 'Hubspot API',
    },
    ...
    for (let i = 0; i < items.length; i++) {
      try {
        ...
        if (resource === 'customer' && operation === 'create') {
          ...
          const createResponse = await this.helpers.httpRequestWithAuthentication.call(this, 'hubspotApi', {
            method: 'POST',
        ...
        if (resource === 'customer' && operation === 'update') {
          ...
          const existing = await this.helpers.httpRequestWithAuthentication.call(this, 'hubspotApi', {
            method: 'GET',
          ...
          const updateResponse = await this.helpers.httpRequestWithAuthentication.call(this, 'hubspotApi', {
            method: 'PUT',
            url: `${baseUrl}/Customers/${customerId}`,
            headers: { ...headers, 'Content-Type': 'application/json' },
            body,
        ...
        if (resource === 'salesOrder') {
          ...
          if (operation === 'create') {
            ...
            if (inputMode === 'json') {
              ...
              if (fetchShipAddress) {
                const shipCustomer = await this.helpers.httpRequestWithAuthentication.call(this, 'hubspotApi', {
                  method: 'GET',
          ...
          if (operation === 'createShipment') {
            ...
            const shipmentResponse = await this.helpers.httpRequestWithAuthentication.call(this, 'hubspotApi', {
              method: 'POST',
          ...
          if (operation === 'updateStatus') {
            ...
            const statusResponse = await this.helpers.httpRequestWithAuthentication.call(this, 'hubspotApi', {
              method: 'PUT',
          ...
          if (operation === 'updateShippingInstructions') {
            ...
            const siResponse = await this.helpers.httpRequestWithAuthentication.call(this, 'hubspotApi', {
              method: 'PUT',
          ...
          if (operation === 'updatePONumber') {
            ...
            const poResponse = await this.helpers.httpRequestWithAuthentication.call(this, 'hubspotApi', {
              method: 'PUT',
          ...
          if (operation === 'updateShipVia') {
            ...
            const svResponse = await this.helpers.httpRequestWithAuthentication.call(this, 'hubspotApi', {
              method: 'PUT',
          ...
          if (operation === 'updateShipDate') {
            ...
            const sdResponse = await this.helpers.httpRequestWithAuthentication.call(this, 'hubspotApi', {
              method: 'PUT',
          ...
          if (operation === 'updateInternalNotes') {
            ...
            const getResponse = await this.helpers.httpRequestWithAuthentication.call(this, 'hubspotApi', {
              method: 'GET',
            ...
            const inResponse = await this.helpers.httpRequestWithAuthentication.call(this, 'hubspotApi', {
              method: 'PUT',
              url: `${baseUrl}/SalesOrders/${fullId}/InternalNotes`,
              headers: { ...headers, 'Content-Type': 'application/json' },
              body,
        ...
        if (resource === 'product' && operation === 'getProductInventoryPricingInquiry') {
          ...
          const [inventoryResponse, singlePricingResponse, maxPricingResponse] = await Promise.all([
            this.helpers.httpRequestWithAuthentication.call(this, 'hubspotApi', {
              method: 'GET',
