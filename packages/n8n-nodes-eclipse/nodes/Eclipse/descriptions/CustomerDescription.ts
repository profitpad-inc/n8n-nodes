...
export const customerDescription: INodeProperties[] = [
  ...
  },
  {
    ...
    type: 'string',
    default: '',
    placeholder: 'id,name,contacts.firstName',
    description: 'Comma-separated list of fields to include in each result. Supports dot notation for nested fields (e.g. contacts.firstName).',
    displayOptions: {
      show: {
        resource: ['customer'],
        operation: ['getMany'],
  ...
  },
  {
    ...
    options: [
      ...
      { displayName: 'City', name: 'city', type: 'string', default: '' },
      {
        ...
        default: '',
        placeholder: '123,456',
        description: 'Comma-separated list of contact IDs to associate with the customer',
      },
      ...
      { displayName: 'Postal Code', name: 'postalCode', type: 'string', default: '', description: 'ZIP / postal code' },
      {
        ...
        default: '',
        placeholder: '123,456',
        description: 'Comma-separated list of ship-to customer IDs',
      },
      {
      ...
      },
      {
        ...
        type: 'string',
        default: '',
        placeholder: 'PROPANE,LVL-2',
        description: 'Comma-separated list of customer types',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      { displayName: 'City', name: 'city', type: 'string', default: '' },
      {
        ...
        default: '',
        placeholder: '123,456',
        description: 'Comma-separated list of contact IDs. Replaces the existing contacts if provided.',
      },
      { displayName: 'Default PO Number', name: 'defaultPoNumber', type: 'string', default: '' },
      { displayName: 'Default Price Class', name: 'defaultPriceClass', type: 'string', default: '' },
      { displayName: 'Default Ship Via', name: 'defaultShipVia', type: 'string', default: '' },
      ...
      { displayName: 'Postal Code', name: 'postalCode', type: 'string', default: '' },
      {
        ...
        default: '',
        placeholder: '123,456',
        description: 'Comma-separated list of ship-to customer IDs. Replaces the existing ship-to list if provided.',
      },
      ...
      },
      {
        ...
        default: '',
        placeholder: 'PROPANE,LVL-2',
        description: 'Comma-separated list of customer types. Replaces the existing customer types if provided.',
      },
    ],
  },
  {
