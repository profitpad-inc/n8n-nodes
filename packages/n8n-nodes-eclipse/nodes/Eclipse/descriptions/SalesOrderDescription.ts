  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        type: 'options',
        options: [
          { name: 'Business Connect', value: 'BCS' },
          { name: 'Eclipse API', value: 'API' },
          { name: 'Eclipse B2B', value: 'B2B' },
          { name: 'Eclipse Commerce Connect', value: 'ECC' },
          { name: 'Eclipse Mobile', value: 'MOE' },
          { name: 'Eclipse Service', value: 'SVC' },
          { name: 'Eclipse Showroom', value: 'SHW' },
          { name: 'Electronic Data Exchange', value: 'EDI' },
          { name: 'Email Order Entry', value: 'MBX' },
          { name: 'Epicor Showcase for Eclipse', value: 'ESE' },
          { name: 'IDMS-XML', value: 'IX' },
          { name: 'None', value: '' },
          { name: 'Palm Pilot Order Entry', value: 'PALM' },
          { name: 'Remote Data Collection', value: 'RDC' },
          { name: 'Remote Order Entry', value: 'ROE' },
          { name: 'Sales Force Automation', value: 'SFA' },
          { name: 'SourceOne Interface (Allegis)', value: 'SR1' },
          { name: 'Web Order Entry', value: 'WOE' },
        ],
        default: '',
